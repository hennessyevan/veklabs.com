...
import { useDebounce, useSessionStorage, useThrottle } from "@uidotdev/usehooks"
...
export const VideoInformationPopup = forwardRef<
  HTMLDivElement,
  VideoInformationPopupProps
>(
  (
    { videoURL, meta, image, title, body, type, onOpenChange },
    forwardedRef,
  ) => {
    const [playTime, setPlayTime] = useSessionStorage(videoURL, "0")
